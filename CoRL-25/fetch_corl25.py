#!/usr/bin/env python3
"""
CoRL 2025 - Occupancy 相关论文爬取脚本
通过 OpenReview API 获取 oral / poster 录用论文，按关键词过滤 occupancy 相关
...
# CoRL 2025 录用 venue 标签（对应 content.venue）
ACCEPTED_VENUES = [
    ("CoRL 2025 Oral", "oral"),
    ("CoRL 2025 Poster", "poster"),
]
SUBMISSION_INVITATION = "robot-learning.org/CoRL/2025/Conference/-/Submission"
