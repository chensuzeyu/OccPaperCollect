...
# ICML 2025 录用 venue 标签（对应 content.venue，注意大小写）
# 参考 OpenReview 页面: ICML 2025 poster, ICML 2025 spotlightposter, ICML 2025 oral
ACCEPTED_VENUES = [
    ("ICML 2025 poster", "poster"),
    ("ICML 2025 spotlightposter", "spotlight"),
    ("ICML 2025 oral", "oral"),
]
